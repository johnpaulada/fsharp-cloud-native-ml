...
namespace SampleBinaryClassification.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"/Users/johnpaulada/Projects/fsharp-cloud-native-ml/wikipedia-detox-250-line-data.tsv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.SgdCalibrated(new SgdCalibratedTrainer.Options() { L2Regularization = 1E-07f, ConvergenceTolerance = 1E-05f, NumberOfIterations = 20, Shuffle = false, LabelColumnName = "Sentiment", FeatureColumnName = "Features" });
